...
public class SixBySixSudokuBoardFactoryTest {
    private SixBySixSudokuBoardFactory factory;
    ...
    public void setUp() {
        ...
        factory = new SixBySixSudokuBoardFactory(fileReader);
    }

    @Test
    public void testCreateSudokuBoardValid() throws IOException {
        String validSudokuString = "123456123456123456123456123456123456";
    ...
    public void testCreateSudokuBoardInvalid() throws IOException {
        String invalidSudokuString = "12345612345612345612345612345612345";
