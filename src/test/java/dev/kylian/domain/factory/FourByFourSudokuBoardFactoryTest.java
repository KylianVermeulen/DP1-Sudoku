...
public class FourByFourSudokuBoardFactoryTest {
    private FourByFourSudokuBoardFactory factory;
    ...
    public void setUp() {
        ...
        factory = new FourByFourSudokuBoardFactory(fileReader);
    }

    @Test
    public void testCreateSudokuBoardValid() throws IOException {
        String validSudokuString = "1234123412341234";
    ...
    public void testCreateSudokuBoardInvalid() throws IOException {
        String invalidSudokuString = "123412341234123";
